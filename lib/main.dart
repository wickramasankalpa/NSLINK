                ...
                child: ListTile(
                  ...
                  onTap: () {
                    Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) =>
                            LecturePage(lecturerId: lecturer.id),
                      ),
                    );
                  },
                ),
    ...
    try {
      ...
      if (lecturerDoc.exists) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Lecturer not found')),
        );
      }
    } catch (e) {
  ...
  Future<void> bookSlot(int index) async {
    try {
      ...
      if (result == true) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Appointment reserved!!')),
        );
      }
    } catch (e) {
