...
import 'package:lecturer_meeting/add_slot.dart';
...
class _LecturerDashboardState extends State<LecturerDashboard>
  ...
  Future<void> _fetchLecturerData() async {
    ...
    try {
      ...
      setState(() {
        _bookedMeetings = bookingsQuery.docs
            .map((doc) => {
                  ...doc.data(),
                  'id': doc.id,
                })
        ...
        _availableSlots = slotsQuery.docs
            .map((doc) => {
                  ...doc.data(),
                  'id': doc.id,
                })
  ...
  Future<void> _showRemoveConfirmation(
      String slotId, String date, String time) async {
          ...
          content: SingleChildScrollView(
            child: Column(
              ...
              children: [
                ...
                _detailRow(
                    'Has Attachment', meeting['hasAttachment'] ? 'Yes' : 'No'),
              ],
            ),
          ),
          actions: [
                        ...
                        itemBuilder: (context, index) {
                          ...
                          return Card(
                            ...
                            child: ListTile(
                              ...
                              trailing: meeting['hasAttachment'] == true
