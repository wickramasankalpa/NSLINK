...
import 'package:my_app/admin/homeScreen.dart';
import 'package:my_app/admin/singleLeaveView.dart';
...
class RequestCard extends StatelessWidget {
  ...
  const RequestCard({Key? key, required this.leaveData}) : super(key: key);
